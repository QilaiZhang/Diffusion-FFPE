...
class VitExtractor:
    ...
    def __init__(self, model_name, device):
        # pdb.set_trace()
        self.model = torch.hub.load('/mnt_ljw/fro2ffpe_projects/img2img-turbo-main/dino-main/', model_name,
                                    source='local', pretrained=False).to(device)
        self.model.load_state_dict(
            torch.load("/mnt_ljw/fro2ffpe_projects/img2img-turbo-main/dino-main/dino_vitbase8_pretrain.pth"),
            strict=True)
        self.model.eval()
